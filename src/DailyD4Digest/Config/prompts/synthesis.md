...
- **D4** — How you sustain: 2× output needs ½ cost of ownership, or the speed is borrowed. Operating in production: agentic SRE, incidents, observability, maintenance, tech debt; inference/token cost secondary
